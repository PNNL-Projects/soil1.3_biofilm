...
pop_vol_1d_df["Total"] = pop_vol_1d_df["V. paradoxus"] + pop_vol_1d_df["S. fribergensis"] + pop_vol_1d_df["Rhodococcus spp."]
...
df["dv_dvol"] = np.gradient(df["V. paradoxus / Volume"], df["Relative Volume"])
df["ds_dvol"] = np.gradient(df["S. fribergensis / Volume"], df["Relative Volume"])
df["dr_dvol"] = np.gradient(df["Rhodococcus spp. / Volume"], df["Relative Volume"])
df["dv_drad"] = np.gradient(df["V. paradoxus / Volume"], df["Radius"])
df["ds_drad"] = np.gradient(df["S. fribergensis / Volume"], df["Radius"])
df["dr_drad"] = np.gradient(df["Rhodococcus spp. / Volume"], df["Radius"])
df["dvol_drad"] = np.gradient(df["Relative Volume"], df["Radius"])
df["Habitant size"] = pd.NA
df.loc[df["Relative Volume"] < 0.4, "Habitant size"] = "Small"
df.loc[(df["Relative Volume"] >= 0.5) & (df["Relative Volume"] < 0.7), "Habitant size"] = "Medium"
df.loc[df["Relative Volume"] >= 0.8, "Habitant size"] = "Large"
# color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue'}
# sns.scatterplot(data=df, y="V. paradoxus / Volume", x="Relative Volume", hue="Carbon")
# sns.scatterplot(data=df, y="S. fribergensis / Volume", x="Relative Volume", hue="Carbon")
# sns.scatterplot(data=df, y="Rhodococcus spp. / Volume", x="Relative Volume", hue="Carbon")

# sns.scatterplot(data=df, y="V. paradoxus", x="Relative Volume", hue="Carbon")
sns.scatterplot(data=df, y="S. fribergensis", x="Volume", hue="Carbon")
# sns.scatterplot(data=df, y="Rhodococcus spp.", x="Relative Volume", hue="Carbon")
...
df = pop_vol_1d_df.copy()
df["Habitant size"] = pd.NA
df.loc[df["Relative Volume"] < 0.3, "Habitant size"] = "Small"
df.loc[(df["Relative Volume"] >= 0.4) & (df["Relative Volume"] < 0.7), "Habitant size"] = "Medium"
df.loc[df["Relative Volume"] >= 0.8, "Habitant size"] = "Large"
# df.loc[df["Relative Volume"] < 0.2, "Habitant size"] = "[0,0.2)"
# df.loc[df["Relative Volume"] < 0.1, "Habitant size"] = "[0,0.1)"
# df.loc[(df["Relative Volume"] >= 0.1) & (df["Relative Volume"] < 0.2), "Habitant size"] = "[0.1,0.2)"
# df.loc[(df["Relative Volume"] >= 0.2) & (df["Relative Volume"] < 0.3), "Habitant size"] = "[0.2,0.3)"
# df.loc[(df["Relative Volume"] >= 0.3) & (df["Relative Volume"] < 0.4), "Habitant size"] = "[0.3,0.4)"
# df.loc[(df["Relative Volume"] >= 0.4) & (df["Relative Volume"] < 0.5), "Habitant size"] = "[0.4,0.5)"
# df.loc[(df["Relative Volume"] >= 0.5) & (df["Relative Volume"] < 0.6), "Habitant size"] = "[0.5,0.6)"
# df.loc[(df["Relative Volume"] >= 0.6) & (df["Relative Volume"] < 0.7), "Habitant size"] = "[0.6,0.7)"
# df.loc[(df["Relative Volume"] >= 0.7) & (df["Relative Volume"] < 0.8), "Habitant size"] = "[0.7,0.8)"
# df.loc[(df["Relative Volume"] >= 0.8) & (df["Relative Volume"] < 0.9), "Habitant size"] = "[0.8,0.9)"
# df.loc[df["Relative Volume"] >= 0.9, "Habitant size"] = "[0.9,1.0)"
# df.loc[df["Relative Volume"] >= 0.8, "Habitant size"] = "[0.8,1.0]"
# df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["Total", "V. paradoxus", "S. fribergensis", "Rhodococcus spp."], var_name="Species", value_name="Biomass")
# color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue', 'Total': 'grey'}
df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["V. paradoxus", "S. fribergensis", "Rhodococcus spp."], var_name="Species", value_name="Biomass")
color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue'}
# df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["V. paradoxus / Volume", "S. fribergensis / Volume", "Rhodococcus spp. / Volume"], var_name="Species", value_name="Biomass / Habitant size")
# color_map = {'V. paradoxus / Volume': 'red', 'S. fribergensis / Volume': 'green', 'Rhodococcus spp. / Volume': 'blue'}

df4plot = df4plot.loc[df4plot["Time"] == 90]
df4plot = df4plot.loc[df4plot["Biomass"] > 0]
# sns.boxplot(data=df4plot[df4plot["Time"] == 90 & (df4plot["Carbon"] == "Nag")], x="Habitant size", y="Biomass", hue="Species", palette=color_map, sym = "")
# sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Nag")], x="Habitant size", y="Biomass", hue="Species", palette=color_map, sym = "")
sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Chito5")], x="Habitant size", y="Biomass", hue="Species", palette=color_map, sym = "")
# sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Chitin")], x="Habitant size", y="Biomass", hue="Species", palette=color_map, sym = "")
# plt.ylim(1, 1.5e4)
# plt.yscale("log")
...
```{python}
df = pop_den_1d_df.copy()
df = df.loc[(df[["V. paradoxus", "S. fribergensis", "Rhodococcus spp."]] != 0).all(axis=1)]
df["Habitant size"] = pd.NA
df.loc[df["Relative Volume"] < 0.3, "Habitant size"] = "Small"
df.loc[(df["Relative Volume"] >= 0.4) & (df["Relative Volume"] < 0.7), "Habitant size"] = "Medium"
df.loc[df["Relative Volume"] >= 0.8, "Habitant size"] = "Large"
...
# df.loc[df["Relative Volume"] >= 0.9, "Habitant size"] = "[0.9,1.0)"
# df.loc[df["Relative Volume"] >= 0.8, "Habitant size"] = "[0.8,1.0]"
# df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["Total", "V. paradoxus", "S. fribergensis", "Rhodococcus spp."], var_name="Species", value_name="Density")
# color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue', 'Total': 'grey'}
df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["V. paradoxus", "S. fribergensis", "Rhodococcus spp."], var_name="Species", value_name="Density")
color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue'}
# df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant size", "Radius", "Relative Volume"], value_vars=["V. paradoxus / Volume", "S. fribergensis / Volume", "Rhodococcus spp. / Volume"], var_name="Species", value_name="Density / Habitant size")
# color_map = {'V. paradoxus / Volume': 'red', 'S. fribergensis / Volume': 'green', 'Rhodococcus spp. / Volume': 'blue'}

df4plot = df4plot.loc[df4plot["Density"] > 0]
# df4plot = df4plot.loc[df4plot["Time"] == 37]
# sns.boxplot(data=df4plot[df4plot["Time"] == 90 & (df4plot["Carbon"] == "Nag")], x="Habitant size", y="Density", hue="Species", palette=color_map, sym = "")
# sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Nag")], x="Habitant size", y="Density", hue="Species", palette=color_map, sym = "")
# sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Chito5")], x="Habitant size", y="Density", hue="Species", palette=color_map, sym = "")
# sns.boxplot(data=df4plot[(df4plot["Carbon"] == "Chitin")], x="Habitant size", y="Density", hue="Species", palette=color_map, sym = "")
# plt.ylim(1, 1.5e4)
# plt.yscale("log")
...
for time in [11, 37, 90]:
    for carbon in ["Nag", "Chito5", "Chitin"]:
        ...
        sns.boxplot(data=df4plot2, x="Habitant size", y="Density", hue="Species", palette=color_map, sym = "")
        plt.legend([],[], frameon=False)
        plt.savefig(result_dir + "density_vs_habitant_size_" + carbon + "_at_" + str(time) + "pdf", bbox_inches='tight', dpi=300)
        plt.close()
...
```{python}
df = pop_vol_1d_df.copy()
df["Habitant position"] = pd.NA
df.loc[df["Radius"] < 1500, "Habitant position"] = "Left"
df.loc[(df["Radius"] >= 1500) & (df["Radius"] < 3000), "Habitant position"] = "Middle"
df.loc[df["Radius"] >= 3000, "Habitant position"] = "Right"
df4plot = pd.melt(df, id_vars=["Time", "Carbon", "Habitant position", "Radius", "Relative Volume"], value_vars=["V. paradoxus", "S. fribergensis", "Rhodococcus spp."], var_name="Species", value_name="Biomass")
color_map = {'V. paradoxus': 'red', 'S. fribergensis': 'green', 'Rhodococcus spp.': 'blue'}
...
for time in [11, 37, 90]:
    for carbon in ["Nag", "Chito5", "Chitin"]:
        df4plot2 = df4plot.loc[df4plot["Time"] == time & (df4plot["Carbon"] == carbon)]
        sns.boxplot(data=df4plot2, x="Habitant position", y="Biomass", hue="Species", palette=color_map, sym = "")
        plt.legend([],[], frameon=False)
        plt.yscale("log")
        plt.savefig(result_dir + "biomass_vs_habitant_position_" + carbon + "_at_" + str(time) + "pdf", bbox_inches='tight', dpi=300)
        plt.close()
