...
```{python}
df = pop_den_1d_df.copy()
# dft = df[(df["Carbon"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Carbon"] == "NAG") & (df["Time"] == 66) & (df["Rep"] == "rep3")].copy()
# dft = df[(df["Carbon"] == "NAG") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Carbon"] == "Chitopentose") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Carbon"] == "Chitin") & (df["Time"] == 66) & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Carbon"] == "NAG") & (df["Time"] == 66)].copy()
# dft = df[(df["Carbon"] == "NAG") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
# dft = df[(df["Carbon"] == "Chitopentose") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
dft = df[(df["Carbon"] == "Chitin") & (df["Radius"] % (100 * pixel_size) == 0)].copy()
...
# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Carbon"] == "NAG")]
# ax = sns.boxplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
# plt.ylim(0, 1.1e8)
# plt.legend([],[], frameon=False)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
# annotator.configure(test='Mann-Whitney', text_format='star', loc='outside')
# annotator.apply_and_annotate()
# plt.savefig(analysis_dir + "boxplot_NAG_volume.pdf", bbox_inches='tight', dpi=300)
# plt.close()

# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Carbon"] == "Chitopentose")]
# ax = sns.boxplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
# plt.ylim(0, 1.1e8)
# plt.legend([],[], frameon=False)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
...
# df = pop_vol_melted[(pop_vol_melted["Species"] != "Total") & (pop_vol_melted["Carbon"] == "Chitin")]
# ax = sns.boxplot(data=df, x="Time", y="Biomass", hue="Species", palette=color_map)
# plt.ylim(0, 1.1e8)
# annotator = Annotator(ax, pairs, data=df, x="Species", y="Biomass") #, order=order)
# annotator.configure(test='Mann-Whitney', text_format='star', loc='outside')
...
df = pop_vol_melted[(pop_vol_melted["Carbon"] == "NAG")]
...
df = pop_vol_melted[(pop_vol_melted["Carbon"] == "Chitopentose")]
...
df = pop_vol_melted[(pop_vol_melted["Carbon"] == "Chitin")]
...
pairs=[
    [(11, "Sphingopyxis"), (37, "Sphingopyxis")], 
    [(11, "Rhodococcus"),(37, "Rhodococcus")], 
    [(11, "Variovorax"), (37, "Variovorax")],
    
    [(37, "Sphingopyxis"), (90, "Sphingopyxis")], 
    [(37, "Rhodococcus"),(90, "Rhodococcus")], 
    [(37, "Variovorax"), (90, "Variovorax")],
    ]
...
for time in [90]:
    for carbon in ["NAG", "Chitopentose", "Chitin"]:
        for species in ["Variovorax", "Sphingopyxis", "Rhodococcus"]:
            print("The average biomass of {} in {} condition at {} hours is {}".format(species, carbon, time, df[(df["Carbon"] == carbon) & (df["Time"] == time) & (df["Species"] == species)]["Biomass"].mean()))
```
...
for time in [11, 37, 90]:
    for carbon in ["NAG", "Chitopentose", "Chitin"]:
        ...
        ax = sns.boxplot(data=df4plot2, x="Habitat size", y="Density", hue="Species", palette=color_map, showfliers = False, order=["(0.2~0.4)", "(0.4~0.6)", "(0.6~0.8)", "(0.8~1.0)"])
